...
export const columns: ColumnDef<AdminStoreType>[] = [
  ...
  },
  {
    ...
    header: "",
    cell: ({ row }) => {
      return <ViewStoreButton store={row.original} />;
    },
  },
  {
    id: "actions",
...
// Define props interface for ViewStoreButton component
interface ViewStoreButtonProps {
  store: AdminStoreType;
}

// ViewStoreButton component definition
const ViewStoreButton: React.FC<ViewStoreButtonProps> = ({ store }) => {
