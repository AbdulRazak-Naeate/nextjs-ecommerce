...
// Prisma models
import { Role, ShippingRate, Store } from "@prisma/client";
...
export const updateStoreStatus = async (
 ...
 // Update the user role
    ...
    console.log("updatedStore.userId : ", updatedStore.userId);
     await clerkClient.users.updateUserMetadata(updatedStore.userId, {
      privateMetadata: {
        role: "SELLER",
      },
    });
