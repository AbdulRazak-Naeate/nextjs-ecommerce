...
export const upsertCategory = async (category: Category) => {
  try {
    ...
    // Ensure required fields are present to avoid Prisma validation errors
    if (!category.name || typeof category.name !== "string") {
      console.log("upsertCategory: missing or invalid 'name' field. Keys:",
        Object.keys(category),
        "types:",
        Object.fromEntries(Object.keys(category).map((k) => [k, typeof (category as any)[k]])),
        "stack:",
        new Error().stack
      );
    ...
    if (!category.url || typeof category.url !== "string") {
      console.log("upsertCategory: missing or invalid 'url' field. Keys:",
        Object.keys(category),
        "types:",
        Object.fromEntries(Object.keys(category).map((k) => [k, typeof (category as any)[k]])),
        "stack:",
      ...
      throw new Error("Please provide category url.");
    }
