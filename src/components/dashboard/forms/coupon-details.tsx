    ...
    try {
      ...
      // Upserting category data
       const currentValues = form.getValues();
        ...
        const code = (currentValues.code ?? values.code)?.toString().trim();
      const discount = Number((currentValues.discount ?? values.discount)?.toString().trim());
      const startDate = (currentValues.startDate ?? values.startDate)?.toString().trim();
      const endDate = (currentValues.endDate ?? values.endDate)?.toString().trim();
